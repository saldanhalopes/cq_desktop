 ...
 * @author rafael.lopes
 */
public class AtividadePreparo {

    private int atividade_preparo_id;
    private Metodologia metodologia;
    private Cromatografo cromatografo;
    private Analise analise;
    private String categoria_preparo;
    private String tipo_preparo;
    private String descricao_preparo;
    private String lote_preparo;
    private Double qtd_preparo;
    ...
    private String obs_preparo;
    private Boolean retrabalho_preparo;
    ...
    public int getAtividade_preparo_id() {
        return atividade_preparo_id;
    }

    public void setAtividade_preparo_id(int atividade_preparo_id) {
        this.atividade_preparo_id = atividade_preparo_id;
    }
    ...
    public String getCategoria_preparo() {
        return categoria_preparo;
    }

    public void setCategoria_preparo(String categoria_preparo) {
        this.categoria_preparo = categoria_preparo;
    }

    public String getTipo_preparo() {
        return tipo_preparo;
    }

    public void setTipo_preparo(String tipo_preparo) {
        this.tipo_preparo = tipo_preparo;
    }

    public String getDescricao_preparo() {
        return descricao_preparo;
    }

    public void setDescricao_preparo(String descricao_preparo) {
        this.descricao_preparo = descricao_preparo;
    }

    public String getLote_preparo() {
        return lote_preparo;
    }

    public void setLote_preparo(String lote_preparo) {
        this.lote_preparo = lote_preparo;
    }

    public Double getQtd_preparo() {
        return qtd_preparo;
    }

    public void setQtd_preparo(Double qtd_preparo) {
        this.qtd_preparo = qtd_preparo;
    }
    ...
    public String getObs_preparo() {
        return obs_preparo;
    }

    public void setObs_preparo(String obs_preparo) {
        this.obs_preparo = obs_preparo;
    }

    public Boolean getRetrabalho_preparo() {
        return retrabalho_preparo;
    }

    public void setRetrabalho_preparo(Boolean retrabalho_preparo) {
        this.retrabalho_preparo = retrabalho_preparo;
    }
