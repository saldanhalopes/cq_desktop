...
public final class FrmRetiradaProduto extends javax.swing.JInternalFrame {
    ...
    private boolean novoCadastroProduto = false;
    ...
    public final void readAnalises(int id) {
        ...
        model.setNumRows(0);
        for (Analise anls : equipDao.readAnaliseMetodologia(id, true)) {
            model.addRow(new Object[]{
                anls.getAnalise_id(),
                anls.getAnalise(),
    ...
    private void carregarDadosCadastroProduto(int id) {
        ...
        //txtObsProduto.setText(lot.getLote_obs());
        //txtQuantidade.setText(lot.getQuantidade_amostra());
        SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
//        try {
//            Date date = formatter.parse(lot.getData_entrada());
//            //txtEntradaProduto.setDate(date);
...
//        }
    ...
    private void criarCadastroProduto() {
        ...
        try {
            ...
            //prod.setProduto_id(Integer.parseInt(txtIdProduto.getText()));
            ...
            //lot.setData_entrada(DateTime.getDate(txtEntradaProduto.getDate()));
            //Calendar c = txtEntradaProduto.getCalendar();
            //c.add(Calendar.DATE, +5);
            //lot.setData_prevista(DateTime.getDate(c.getTime()));
            //lot.setLote_obs(txtObsProduto.getText().toUpperCase());
            //lot.setQuantidade_amostra(txtObsProduto.getText().toUpperCase());
    ...
    private void atulizarCadastroProduto(int lote_id) {
        ...
        try {
            ...
            //lot.setLote_status(cmbStatusCadastroProduto.getSelectedItem().toString());
            //lot.setLote_obs(txtObsProduto.getText().toUpperCase());
            //lot.setQuantidade_amostra(txtQuantidade.getText().toUpperCase());
    ...
    private void initComponents() {
        ...
        if (tblAnaliseMetodo.getColumnModel().getColumnCount() > 0) {
            tblAnaliseMetodo.getColumnModel().getColumn(0).setMinWidth(80);
            tblAnaliseMetodo.getColumnModel().getColumn(0).setPreferredWidth(80);
            tblAnaliseMetodo.getColumnModel().getColumn(0).setMaxWidth(80);
            tblAnaliseMetodo.getColumnModel().getColumn(2).setMinWidth(100);
            tblAnaliseMetodo.getColumnModel().getColumn(2).setPreferredWidth(100);
            tblAnaliseMetodo.getColumnModel().getColumn(2).setMaxWidth(100);
            tblAnaliseMetodo.getColumnModel().getColumn(3).setMinWidth(120);
            tblAnaliseMetodo.getColumnModel().getColumn(3).setPreferredWidth(120);
            tblAnaliseMetodo.getColumnModel().getColumn(3).setMaxWidth(120);
        }
        ...
        pnlRetiradaProduto.addTab("Amostras", pnlEntrada);
...
//        if (txtLoteProduto.getText().isEmpty()) {
 ...
 //       } else if (txtIdProduto.getText().isEmpty()) {
  //          JOptionPane.showMessageDialog(null, "Selecionar Material");
  ...
  //      } else if (((JTextField) txtEntradaProduto.getDateEditor().getUiComponent()).getText().isEmpty()
  //              || txtEntradaProduto.getDate().toString().isEmpty()) {
  //          JOptionPane.showMessageDialog(null, "Data Inválida");
  //      } else if (novoCadastroProduto) {
