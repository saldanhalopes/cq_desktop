...
public class AmostraDAO {
    ...
    public void createAmostra(Amostra ams) {
        ...
        try {
            stmt = conn.prepareStatement("INSERT INTO tb_amostra "
                    ...
                    + "quantidade_amostra, obs_amostra) "
                    + "VALUES (?,?,?,?,?)");
            ...
            stmt.setString(4, ams.getQuantidade_amostra());
            stmt.setString(5, ams.getObs_amostra());
            stmt.executeUpdate();
    ...
    public List<Amostra> readAmostra() {
        ...
        try {
            stmt = conn.prepareStatement("Select tb_amostra.amostra_id, tb_amostra.quantidade_amostra, "
                    + "tb_amostra.obs_amostra, tb_lote.lote_produto, "
    ...
    public void updateAmostra(Amostra ams) {
        ...
        try {
            ...
            stmt.setString(4, ams.getQuantidade_amostra());
            stmt.setString(5, ams.getObs_amostra());
            stmt.setInt(6, ams.getAmostra_id());
            stmt.executeUpdate();
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null, "Erro: " + ex);
        } finally {
    ...
    public void selectAmostra(Amostra ams) {
        ...
        try {
            stmt = conn.prepareStatement("Select tb_amostra.amostra_id, tb_amostra.quantidade_amostra, "
                    + "tb_amostra.obs_amostra, tb_amostra_status.amostra_status "
                    + "FROM tb_amostra "
                    + "Inner JOIN tb_amostra_status "
                    + "ON tb_amostra.amostra_status_id = tb_amostra_status.amostra_status_id "
