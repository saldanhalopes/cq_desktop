...
public class Analise {
    ...
    //tb_amostra
    private boolean analise_criada;
    ...
    public boolean isMetodologia_analise_ativo() {
    ...
    public boolean isAnalise_criada() {
        return analise_criada;
    }

    public void setAnalise_criada(boolean analise_criada) {
        this.analise_criada = analise_criada;
    }
